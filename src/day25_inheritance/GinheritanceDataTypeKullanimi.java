...
public class GinheritanceDataTypeKullanimi {
    public static void main(String[] args) {
        ...
        Object obj1=str; // String is an Object
        Object obj2=sayi; // Integer is an Object
        Object obj3=bl; //Boolean is an Object
        Object obj4=new String("Tava");


        // Integer dnm1=str; //String is an Integer diyemiyoruz
