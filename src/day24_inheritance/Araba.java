...
public class Araba {
    ...
    /*
       ...
       Olusturulaca muhtemel class'lar belirlenmeli,
       ...
       sadece child class'larini organize etmek ve ortak ozellikleri belirlemek icin
       tasarlanan class'lardir. Bu tur class'larda main method olmasina gerek yoktur.
       (abstract class ve interface'lerde dah ayrintili anlatilacak)

       Bir ozelligi variable olarak olusturmak ile
       method olarak olusturmak arasinda
       kullanimda bir fark vardir.(Overridin konusunda ele alinaacak)
     */
}
