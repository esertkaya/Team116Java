...
public class Corolla extends BToyota {
    ...
    String lastik="Corolla araclar pirelli 205-60-16 lastikler kullanir";
    ...
    public void hiz(){
        System.out.println("Corolla araclar maximum 240 km hiz yapar");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(corolla1.tekersayisi);//Araba 4
        corolla1.hiz();//C 240
