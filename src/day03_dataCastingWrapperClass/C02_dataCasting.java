...
public class C02_dataCasting {
    ...
    public static void main(String[] args) {
        ...
        sayi=(int)dbl2;
        System.out.println("14.01 int olarak : " +sayi); // sayi

        sayi=(byte)dbl3;
        System.out.println("140.32 byte olarak : " +sayi);

        // 2 kere casting var
        //1- double sayiyi once explicit narrowing ile byte'a ceviriyor.
        //2- byte'a cevrilen sayiyi autowidening ile int'a cast ediyor.
